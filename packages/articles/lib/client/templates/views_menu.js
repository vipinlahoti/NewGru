var getMenuItems = function () {
  var defaultItems = Grudr.menuItems.get("viewsMenu");
  ...
  var viewableItems = _.reject(defaultItems, function (item) {
    return (item.adminOnly && !Users.is.admin(Meteor.user())) || (!!Settings.get('articleViews') && !_.contains(Settings.get('articleViews'), item.name));
  });

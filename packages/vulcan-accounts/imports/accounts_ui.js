...
Accounts.ui._options = {
  ...
  homeRoutePath: '/',
  dashboardRoutePath: '/dashboard',
  onSubmitHook: () => {},
  onPreSignUpHook: () => new Promise(resolve => resolve()),
  onPostSignUpHook: () => redirect(`${Accounts.ui._options.dashboardRoutePath}`),
  ...
  onSignedInHook: () => redirect(`${Accounts.ui._options.dashboardRoutePath}`),

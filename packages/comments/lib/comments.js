...
Comments.schema = new SimpleSchema({
  ...
  */
  articleId: {
    ...
    // regEx: SimpleSchema.RegEx.Id,
    max: 500,
    // editableBy: ["member", "admin"], // TODO: should users be able to set articleId, but not modify it?
    autoform: {
      omit: true // never show this
    }
  },
...
Comments.allow({
  update: _.partial(Grudr.allowCheck, Comments),
  remove: _.partial(Grudr.allowCheck, Comments)
});

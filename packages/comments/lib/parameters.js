...
Comments.parameters.get = function (terms) {
  ...
  var parameters = Grudr.utils.deepExtend(true, {}, Comments.views.baseParameters);

  // get query parameters according to current view
  if (typeof Comments.views[terms.view] !== 'undefined')
    parameters = Grudr.utils.deepExtend(true, parameters, Comments.views[terms.view](terms));

  // iterate over commentsParameters callbacks
  parameters = Grudr.callbacks.run("commentsParameters", parameters, terms);
...
Grudr.callbacks.add("commentsParameters", limitComments);
